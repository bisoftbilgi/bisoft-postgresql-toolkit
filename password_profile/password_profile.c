...
static void password_profile_shmem_request(void);
// This function initializes the data structures in the allocated shared memory.
static void password_profile_shmem_startup(void);
 ...
 */
static void
password_profile_shmem_request(void)
{
    ...
    RequestNamedLWLockTranche("password_profile", 1);
}
 ...
 */
static void
password_profile_shmem_startup(void)
{
    bool        found;
    HASHCTL     ctl;
    ...
    login_state = (LoginAttemptState *) ShmemInitStruct("password_profile_login_state",
    ...
    if (!found)
    {
        ...
        login_state->lock = &(GetNamedLWLockTranche("password_profile")[0].lock);
...
is_password_expired(const char *username)
{
    ...
    snprintf(query, sizeof(query),
             ...
             "FROM password_profile.history WHERE username = %s "
                       ...
                       Datum validuntil_time, bool validuntil_null)
{
    ...
    snprintf(query, sizeof(query),
             "SELECT 1 FROM password_profile.history "
    ...
    snprintf(query, sizeof(query),
             "SELECT 1 FROM (SELECT password_hash FROM password_profile.history "
    ...
    snprintf(query, sizeof(query),
             "INSERT INTO password_profile.history(username, password_hash) "
...
_PG_init(void)
{
    ...
    shmem_request_hook = password_profile_shmem_request;

    prev_shmem_startup_hook = shmem_startup_hook;
    shmem_startup_hook = password_profile_shmem_startup;
    ...
    DefineCustomIntVariable("password_profile.min_length", NULL, NULL,
                            &password_min_length, 8, 1, 128, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomIntVariable("password_profile.expiration_days", NULL, NULL,
                           &password_expiration_days, 0, 0, 3650, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomIntVariable("password_profile.grace_days", NULL, NULL,
                            &password_grace_days, 0, 0, 3650, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomIntVariable("password_profile.reuse_time_days", NULL, NULL,
                           &password_reuse_time_days, 0, 0, 3650, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomIntVariable("password_profile.reuse_max", NULL, NULL,
                            &password_reuse_max, 3, 1, 100, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomBoolVariable("password_profile.require_upper", NULL, NULL,
                             &password_require_upper, true, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomBoolVariable("password_profile.require_lower", NULL, NULL,
                             &password_require_lower, true, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomBoolVariable("password_profile.require_digit", NULL, NULL,
                             &password_require_digit, true, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomBoolVariable("password_profile.require_special", NULL, NULL,
                             &password_require_special, false, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomBoolVariable("password_profile.enable_blacklist", NULL, NULL,
                            &password_enable_blacklist, true, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomBoolVariable("password_profile.allow_hashed", NULL, NULL,
                             &password_allow_hashed, false, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("password_profile.verify_function", NULL, NULL,
                               &password_verify_function, "", PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomIntVariable("password_profile.failed_login_max", NULL, NULL,
                           &password_failed_login_max, 10, 1, 100, PGC_SUSET, 0, NULL, NULL, NULL);
    DefineCustomIntVariable("password_profile.lockout_time_mins", NULL, NULL,
